...
const CrearOrganizacionComponent = () => {
    ...
    const handleSubmit = async (e) => {
        e.preventDefault();
        try {
            await axios.post('http://localhost:9005/api/v1/organization/', organizacion);
            router.push('../VerOrganizaciones');
            alert("Se ha creado satisfactoriamente una Organizacion");
        } catch (error) {
