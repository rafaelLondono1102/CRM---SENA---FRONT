...
const EditarTalentosComponent = ({ talentoEdited, setIsEditing }) => {
    const router = useRouter();
    const [talento, setTalento] = useState({
        _id : talentoEdited._id,
        name: talentoEdited.name,
        gender: talentoEdited.gender,
        economicStatus: talentoEdited.economicStatus,
        age: talentoEdited.age,
        email: talentoEdited.email,
        phone: talentoEdited.phone,
        state: talentoEdited.state,
        city: talentoEdited.city,
        scholarship: talentoEdited.scholarship,
        profession: talentoEdited.profession,
        inscriptionIdea: talentoEdited.inscriptionIdea,
        technologyLine: talentoEdited.technologyLine,
        technologySubLine: talentoEdited.technologySubLine,
        webSite: talentoEdited.webSite,
        socialNetworkName: talentoEdited.socialNetworkName,
        socialNetworkUserName: talentoEdited.socialNetworkUserName,
        observations: talentoEdited.observations
    });
    ...
    const handleSubmit = async (e) => {
        e.preventDefault();
        try {
            await axios.put(`http://localhost:9005/api/v1/talent/${talento._id}`, talento);
            alert("Se ha editado satisfactoriamente un Talento");
...
export default EditarTalentosComponent;
